...
class Ui_indexWindow(object):
    def setupUi(self, indexWindow):
        ...
        self.progressListView.setGeometry(QtCore.QRect(30, 370, 741, 131))
        self.progressListView.setObjectName("progressListView")
        self.singleSubmitBtn = QtWidgets.QPushButton(self.centralwidget)
        self.singleSubmitBtn.setGeometry(QtCore.QRect(570, 510, 101, 41))
        self.singleSubmitBtn.setObjectName("singleSubmitBtn")
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(380, 510, 184, 41))
        self.horizontalLayoutWidget.setObjectName("horizontalLayoutWidget")
        self.singleExecuteLayout = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget)
        self.singleExecuteLayout.setContentsMargins(0, 0, 0, 0)
        self.singleExecuteLayout.setObjectName("singleExecuteLayout")
        self.stopBtn = QtWidgets.QPushButton(self.horizontalLayoutWidget)
        self.stopBtn.setObjectName("stopBtn")
        self.singleExecuteLayout.addWidget(self.stopBtn)
        self.continueBtn = QtWidgets.QPushButton(self.horizontalLayoutWidget)
        self.continueBtn.setObjectName("continueBtn")
        self.singleExecuteLayout.addWidget(self.continueBtn)
